---
title: "AE 03: Central Limit Theorem"
...
This Application Exercise is due on Wednesday, September 16 at 11:59pm. To be considered on time, the following must be done by the due date:
...
Download the template for today's Application Exercise (AE) from Canvas. Open the file, and type your name and today's date in the YAML. Save your file as `ae-03.qmd` in your project folder. 
...
Add in something about simply doing rbinom and asking student to describe what is happening.
