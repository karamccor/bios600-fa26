...
::: callout-important
This homework is due on Wednesay, September 16 at 11:59pm. To be considered on time, the following must be done by the due date:
...
- title -> the assignment name (e.g. `HW 3`)

- author -> your name

- date -> today's date

Now, save your file. Go to File > Save as, and name it something clear like `hw3.qmd`. Keep it in your project folder. You're ready to begin!
