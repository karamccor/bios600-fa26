...
# paste and edit code below: replace blank with Residential, then run code
...
# paste and edit code below: replace blank with driver estimated speed variable, then run code
